...
<html>
  ...
  <body>
    ...
    <div class="front text-center">
      ...
      <div class="background-grey front-descrip">
        <p class="white">
          ...
          towards providing project experience that compliments UCLA's
          engineering coursework. In addition to tools, our organization
          provides like-minded and experienced project leads that provide
          fundamental background knowledge, as well as guide students through
    ...
    <div class="container-fluid">
      <div class="row contact background-light-grey text-left">
        <div class="contact-title col-md-3 col-sm-6">
          <h1>
            CONTACT <br />
            <span class="ieee-blue">INFO</span>
          </h1>
        </div>
    ...
    <div class="involved background-ieee-blue conatiner-fluid text-center">
      ...
      <div class="involvement-wrapper">
        ...
        <div class="involvement text-left">
          ...
          <p>
            ...
            the lab just to say hi to your favorite officers. <br /><br />
        ...
        <div class="involvement text-left">
          ...
          <p>
            ...
            involvement in the future. <br /><br />
            ...
            <br />
            <br />
            Visit <a href="http://gb.ieeebruins.com/">gb.ieeebruins.com</a>!
    ...
    <div class="container-fluid competitions text-center">
      <h1 class="comp-title">
        Our <span class="ieee-blue">Competitions</span>
      </h1>

      <div class="comp-wrapper">
        <div class="flex-wrapper">
          <div class="comp comp-micromouse micromouse text-left col-sm-6">
            <p class="comp-header">
              ALL-AMERICA <br />
              MICROMOUSE
            </p>
      ...
      <div class="row">
        ...
        <div class="spax-title col-md-7">
          ...
          <p class="spax-about">
            ...
            only prepare participants to be leaders in their future careers, but
            also provide opportunities to those who may not have access. Every
            year, the X switches between C for conference and V for venture.
            During SPAC, a group of selected speakers come to share their
            experiences with participants. During SPAV, participants venture out
            to selected companies to learn more about their prospects.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="title col-md-7">
          ...
          <p class="involve-about">
            ...
            new friendships. Some of our favorite events are our Fall BBQ,
            heading out for KBBQ, and our in-house ultimate frisbee tournaments!
            For more information on our events and socials, sign up for our
            mailing list!
          </p>
        </div>
