...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/public/css/edi.css?v=1.0.0?v=1.0.0" />
  </head>
  <body>
    <!-- NAVBAR -->
    ...
    <div class="container-fluid competitions text-center">
      <h1 class="comp-title">
        Our <span class="ieee-blue">Code of Conduct</span>
      </h1>

      <div class="comp-wrapper">
        <div class="flex-wrapper">
          <div class="code-of-conduct text-left">
            <p>
              IEEE at UCLA is committed to upholding equity, diversity, and
              inclusion. Here is our
              <a
                href="https://docs.google.com/document/d/1Z6yylIH9p7UhWdtn85KWZj-D0ZcAWIYodXDFbowBkm0/edit?usp=sharing"
                target="_blank"
                >code of conduct</a
              >:
            </p>
            <iframe
              src="https://docs.google.com/document/d/e/2PACX-1vRMrVNNsZeIUILXd9XWBGKhCaW0HIiNEe9lzwd8q3cGUBxq2Jo7bf1bzfgfW5_oulmD2m64uv5scnaQ/pub?embedded=true"
            ></iframe>
          </div>
        </div>
      </div>
