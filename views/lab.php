...
<html>
  <head>
    ...
    <script src="/public/js/lab.js?v=W23.0"></script>
  ...
  <body>
    ...
    <div class="info-page">
      ...
      <p class="details">
        Here at UCLA, we've been given a lab space that we use as our center of
        operations. The IEEE Lab is an open space for all general members to
        come in, work on their projects, meet new people, talk to present
        ...
        <br /><br />
        Our lab is located at <b>Boelter 2825</b>. The easiest way to find it is
        to go to the west side of 2nd floor Boelter (the lowest balcony). We are
        the second door down from the bridge to E-IV. The IEEE logo is posted on
        our door for easy locating.
      </p>
      <div class="lab-map">
        <a href="/public/images/lab/map.png" target="_blank"
          ><img width="100%" src="/public/images/lab/map.png"
        /></a>
      </div>
    </div>
      ...
      <div class="resources-info black">
        <div class="resource">
          ...
          <p class="black">
            ...
            <br /><br />
            Some of the heavier tools we have include: soldering stations,
            oscilloscopes, power supplies, 3D printers, a drill press, DMM's, a
            big whiteboard, etc. Mostly popular tools used to complete hardware
            related projects. <br /><br />
            We also have smaller, general tools such as: scissors, wire cutters,
            pliers, rulers, screwdrivers, etc.
          </p>
        </div>
        <div class="resource">
          <h2 class="ieee-blue thin">Discord Server</h2>
          <p class="black">
            Originally started to be a virtual lab during the COVID-19 pandemic,
            our Discord server remains the online hub for connecting with IEEE.
            Join our Discord with this link:
            <a href="https://discord.gg/yTR6XUS" target="_blank"
              >https://discord.gg/yTR6XUS</a
            >
          </p>
        </div>
      </div>
